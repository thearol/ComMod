...
In percentages Riccardo and Mikkel answer roughly equally bad. However, since we have many more datapoints from Mikkel, as the posterior distribution shows, we can be much more certain in assessing Mikkel's CogSci knowdge. This is shown in the area under the curve being more narrow compared to Riccardo's.
...
ggplot(new_Data,aes(grid,posterior)) + geom_line(aes(grid,stupid_prior),color='red')+ xlab("Knowledge of CogSci")+ ylab("posterior probability") + labs(title = "Plot of new prior")
