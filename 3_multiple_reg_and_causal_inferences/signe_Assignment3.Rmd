...
```{r}
#Define the model
m1.4.2 <- bf(ADOS ~ 1 + VerbalIQ_c + NonVerbalIQ_c + SocialIQ_c)
...
# Draw the consequences of priors 
m_1.8_prior <- brm(m1.8, asd_3, prior = prior, sample_prior = "only")
# Prior Predictive Check
...
#Define the model
m1.8 <- bf(ADOS ~ 1 + VerbalIQ_c + NonVerbalIQ_c + SocialIQ_c)
